function [KannealG,MeanExpFitG,PiniG]=ModuleFitTime_Pon(RnaSignal,TimeLabel,OutFolder)
...
%             end
            ...
            LldG(T_i,:)=LldPilot;
            [~,Pdtb,~,Pinis,~] =  FSP_FreeSetPon(KannealOut,DataTime,Pinie,LabelPart,0,Kstart,UnLockIndex,Tfit,Change,DtdInherit);%Get Distribution
