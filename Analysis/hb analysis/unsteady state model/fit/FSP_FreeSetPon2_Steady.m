function [lld,varargout] = FSP_FreeSetPon2_Steady(Kanneal,ndata,p_ini,dna_label,hold_time,Kall,AnnealLogic,Tstay,Change,DtdInherit,varargin)
...
P_dtb_rna(1)=P_dtb_rna(1)+1-sum(P_dtb_rna,2);
