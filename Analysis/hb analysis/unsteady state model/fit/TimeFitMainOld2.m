function TimeFitMainOld(Cycle,Model,TimeBin,InheritSwitch,CombinNum)
...
% TimeBin=0.5;
% InheritSwitch=0;
LabelTip='-EL[0 0.6]bin0.1Move0.05-TimeWindowAdd-KL[0.01 0.01 0.60]-KU[0.2 0.2 0.8]-TimeStart60-KDisLost[10 10 1 1 5]-Artifical-Filter5-timeBinMove1-PonBoole0-re4\';
RepeatNum=1;
...
switch Model
    case 'Ton'
        Bound=[...
            ...
            [0.20,0,0.20,0,0,0,0,0.80,0,1,1,1];...
            [0.01,0,0.01,0,0,0,0,0.60,0,0,1,0]];
    case 'TwoState'
        Bound=[...
...
parfor ELi=1:size(EL,2)
    ...
    if CombinNum==0
        ...
        [KannealG,MeanExpFitG,PiniG,TimeLabelPlot,KannealGPlot,PstatePlot,LldPlot]=...
            ModuleCombinFitTime(DataCellMean,TimeLabelMean,RnaLenth,kfitTime,OutFolder,InheritSwitch,RepeatNum,Bound,Model,CombinNum,CombinPart,PonLock,PonTime,PonLocation);
    end
